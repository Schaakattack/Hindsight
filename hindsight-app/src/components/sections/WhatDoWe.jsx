...
export default function WhatDoWe(){
    return (
        <section className='what-do-we pt-16.5 pb-34.5 bg-btn-default-color'>
            <div className='container mx-auto flex flex-col items-center gap-6.5 items-center'>
                <h2 className='font-brand-medium font-semibold text-title-xl brand-50'>What is Hindsight?</h2>
                <p className='text-base font-medium tracking-tighter text-secondary-color text-center'>
